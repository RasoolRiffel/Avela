...
function known_scripts() {
     ...
     */  
    // Google Fonts
    wp_enqueue_style( 'google-fonts', 'https://fonts.googleapis.com/css?family=Lato', array(), null, all );
    ...
    // Known 
    wp_register_script( 'known-main', get_template_directory_uri() . '/assets/js/known.min.js', array('jquery', 'match-height', 'bootstrap'), null, true);
